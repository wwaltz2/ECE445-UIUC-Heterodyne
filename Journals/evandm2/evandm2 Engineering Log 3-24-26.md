...
We've received the rev.1 and rev.2 PCBs, which includes our microphone breakout board. I'd like to get into the lab very soon and solder that up so we can have a working microphone for our upcoming progress demo in a couple of weeks. The analog design is also unchanged from how we have it on rev.2, so this can be tested too!
